...
class SingleUserInfosBody extends StatefulWidget {
  const SingleUserInfosBody({super.key, required this.id});

  final int id;

  @override
  State<SingleUserInfosBody> createState() => _SingleUserInfosBodyState();
}

final GetSingleUserCubit _cubit = injection<GetSingleUserCubit>();

class _SingleUserInfosBodyState extends State<SingleUserInfosBody> {
  @override
  void initState() {
    super.initState();
